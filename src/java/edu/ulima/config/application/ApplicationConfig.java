package edu.ulima.config.application;
...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(edu.ulima.provider.MyJacksonJsonProvider.class);
        resources.add(edu.ulima.resource.MessageResource.class);
