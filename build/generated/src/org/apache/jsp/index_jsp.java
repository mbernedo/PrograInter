  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (session) {
        pokemones = (java.util.ArrayList) _jspx_page_context.getAttribute("pokemones", PageContext.SESSION_SCOPE);
        if (pokemones == null){
          pokemones = new java.util.ArrayList();
          _jspx_page_context.setAttribute("pokemones", pokemones, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\n");
      out.write("<html>\n");
